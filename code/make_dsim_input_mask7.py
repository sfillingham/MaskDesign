...
def input1(maskname, semester, maskPA, masknum):
    ...
    data_updateinfo = fits.open(semester+'/newfirm_mbs_specz_sdss_priority_mask7.fits')[1].data
    ...
    if masknum == 90:
        pflagcut = ((targetPcode == 10000) & (targetINFO != 1)) | ((targetPcode == 100) & (targetINFO != 1)) | ((targetPcode == 5) & (targetINFO != 1))
    else:
...
def input2(maskname, semester, maskPA, masknum):
    ...
    data_updateinfo = fits.open(semester+'/newfirm_mbs_specz_sdss_priority_mask6.fits')[1].data
    targetINFO = data_updateinfo['target']
    ...
    if masknum == 11:
        ...
        hdum = fits.open(semester+'/maskdesign/m17B83a.fits')
    else:
...
def input3(maskname, semester, maskPA, masknum):
    ...
    if masknum == 11:
        ...
        hdum = fits.open(semester+'/maskdesign/m17B83b.fits')
    else:
        print('wrong...try again!')
