...
def input1(maskname, semester, maskPA, masknum):
    ...
    data_updateinfo = fits.open(semester+'/newfirm_mbs_deepz_sdss_priority_mask2.fits')[1].data
...
def input2(maskname, semester, maskPA, masknum):
    ...
    if masknum == 11:
        ...
        hdum = fits.open(semester+'/maskdesign/m17B71a.fits')
    elif masknum == 23:
...
def input3(maskname, semester, maskPA, masknum):
    ...
    if masknum == 11:
        ...
        hdum = fits.open(semester+'/maskdesign/m17B71b.fits')
    elif masknum == 23:
    ...
    #choose this for each pass, depending on what must be on the mask
    if masknum == 71:
        pflagcut = (((targetPcode == 10000) & (targetINFO != 1)) ^ ((targetPcode == 5000) & (targetINFO != 1)) ^ ((targetPcode == 1000) & (targetINFO != 1)))
