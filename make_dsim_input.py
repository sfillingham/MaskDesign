...
def input1(maskname, maskPA, masknum):
    ...
    t.write(maskname+'.input', format='ascii')
...
def input3(maskname, maskPA, masknum):
    ...
    #pflagcut = ((targetPcode == 10000) & (targetINFO != 1)) ^ (targetPcode == 100) ^ ((targetPcode == 1000) & (targetINFO != 1)) ^ (targetPcode == 10) ^ (targetPcode == 5) ^ ((targetPcode == 1) & (targetMAG < 24.) & (targetMAG > 10.) & (targetZ > 1.3) & (targetZ < 0.3)) ^ ((targetPcode == 1) & (targetMAG > 25.5) & (targetZ < 1.3) & (targetZ > 0.3))
